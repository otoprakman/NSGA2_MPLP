...
int main(int, char**)
{
   ...
   /********************************************************************/			
	...
	if (Plot)
	{
		RPath = string("C:\\\"Program Files\"\\R\\R-3.6.2\\bin\\R.exe < C:\\\"Users\"\\...MIP_Sol1_Sol2_Compare.R --no-save"); //Plot results using R scripts-- these may not be available on github
		system(RPath.c_str());
	}
	cin >> STOP;
	return 0;
