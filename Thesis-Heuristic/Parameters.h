...
const int maxInitFacility = 31;		/*While generating initial population, 
...
const int maxlimit_facility = 31;   //Allow maximum number of facilities in the mating pool (including)
